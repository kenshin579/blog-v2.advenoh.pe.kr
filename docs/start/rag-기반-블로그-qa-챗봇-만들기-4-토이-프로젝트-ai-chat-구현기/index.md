...
span
---
> 이 글은 **RAG 기반 블로그 Q&A 챗봇 만들기** 시리즈의 네 번째 편이다. 편 1~3에서 다룬 RAG 이론과 구현을 실제 토이 프로젝트에 적용한 과정을 정리한다.
>
...
각 단계의 이론적 배경은 [편 1](../../read/rag-기반-블로그-qa-챗봇-만들기-1-llm-적응-기법과-rag-개념)을 참조하고, 여기서는 **이 프로젝트에서의 구현 결정**에 집중한다.
