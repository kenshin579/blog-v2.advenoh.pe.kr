...
# 3. Task와 Future
## 3.1 Task 생성 및 관리 (`asyncio.create_task`)
...
# 7. 실전 예제: 비동기 HTTP 요청
## 7.1 httpx `AsyncClient` 기본 사용법
## 7.2 여러 URL 동시 요청 (gather 활용)
## 7.3 응답 시간 비교: 동기 requests vs 비동기 httpx
