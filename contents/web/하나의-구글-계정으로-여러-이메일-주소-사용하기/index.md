...
AWS 계정은 12개월간 무료로 쓸 수 있다. 그래서 나는 매년 AWS 계정을 새로 만들 때 구글 별칭 기능을 쓴다. 따로 설정할 것도 없이 사용자 이름에 점이나 플러스만 붙이면 끝이다.

# 1. 이메일 별칭 (alias) 기능 사용하기

구글의 alias 기능은 `plus`, `dot`을 사용자 이름에 추가해서 이메일을 보내면 원래 구글 메일 계정으로 받을 수 있다.

- 구글 이메일 주소: frank@gmail.com

## 1.1 사용자 이름에 점 (dot) 사용하기
