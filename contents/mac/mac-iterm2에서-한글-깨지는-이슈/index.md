...
iTerm2에서 한글 깨짐 현상은 주로 두 가지 이유로 발생한다. Unicode Normalization Format 설정과 폰트 설정이다. 아래 단계를 따라 설정을 변경하면 문제를 해결할 수 있다.
...
위 단계를 통해 `iTerm2`에서 발생하던 한글 깨짐 문제를 해결할 수 있었다.
