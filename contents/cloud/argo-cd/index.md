...
# 6. Argo CD Application을 생성하기

## 6.1 Argo CLI으로 생성하기

Argo CLI로 application을 생성하려면 Argo CD CLI 설치가 필요하다.

### 6.1.1 Argo CD CLI 설치하기
...
# 7. Docker 이미지를 버전 업시켜 Argo로 동기화 해보기

Application 개발이후 새로운 도커 이미지를 생성했다면, Argo CD로 배포를 해보자.

## 7.1 Kubernetes config 설정 파일 수정
